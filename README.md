...
## Installation
Open group_5_assignment4.pde in Processing. Select menu option Sketch->Import Library->Add Library. Search for PeasyCam and install. Press run to execute program.
